...
// Get all completed shippings for the authenticated user, requiring authentication
router.get("/completed", authenticateToken, shippingController.getCompletedShippings);

// Admin Routes

// Get all shippings, requiring admin authentication
...
// Update a specific shipping by ID, requiring admin authentication
router.post("/admin/update/:id", adminOnly, shippingController.updateShipping);

// Delete a specific shipping by ID, requiring admin authentication
